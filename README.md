...
## 📝 About Me
I am a first-year B.Tech CSE (AI) student passionate about **Artificial Intelligence, Machine Learning, and Full-Stack Development**.  
Currently exploring **OpenVINO, LangChain, Python, React, and DBMS**, and I enjoy building projects that **solve real-world problems using AI and software development**.
...
## 📂 Key Projects
- [**OpenVINO YOLOv8 Demo**](https://github.com/divya5623/openvino-yolov8-demo) – Real-time object detection optimized with OpenVINO.  
- [**Incident Response OpenEnv**](https://github.com/divya5623/incident-response-openenv) – Automated simulation of production incidents for AI-driven responses.
